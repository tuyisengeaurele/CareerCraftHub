...
<body>
  <header>
    ...
    <div class="heading3">
      <h2>Admin:<?php echo $_GET['usernames']; ?>&nbsp;&nbsp; </h2>
    </div>
  </header>

  <nav>
    <a href="#">Home</a>
    <a href="#" onclick="loadContent('Users.php')">User Management</a>
    <a href="Insert users.php">Insert Users</a>
    <a href="Insert Employers.php">Insert Employers</a>
  ...
  <main>
    ...
    <div class="home"><button onclick="loadContent('UserProfile.php')"><i class="fa-solid fa-user"></i>Profile</button></div>
      <div class="home"><button onclick="loadContent('Users.php')"><i class="fa-solid fa-pen-nib"></i>Users</button></div>
      <div class="home"><button onclick="loadContent('Job listings.php')"><i class="fa-solid fa-pen-nib"></i>Job listings</button></div>
